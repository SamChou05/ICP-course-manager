...
import { idlFactory } from './ICP-course-manager.did.js';
export { idlFactory } from './ICP-course-manager.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.ICP-COURSE-MANAGER_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ICP-course-manager.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ICP-course-manager canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ICP-course-manager.did.js")._SERVICE>}
 */
export const ICP-course-manager = createActor(canisterId);
